...
var app = {
    ...
    onDeviceReady: function() {
      ...
      window.publisher = TB.initPublisher(data.apiKey,'myPublisherDiv');
      ...
      session.on({
        'streamCreated': function( event ){
            ...
            window.subscriber = session.subscribe( event.stream, div.id, {subscribeToAudio: false} );
        }
      });
      ...
      $('#subVidOff').click(function(){subscriber.subscribeToVideo(false)});
      $('#subVidOn').click(function(){subscriber.subscribeToVideo(true)});
